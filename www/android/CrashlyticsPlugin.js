...
CrashlyticsPlugin.prototype.addLog = function(message) {
  ...
  cordova.exec(null, null, "CrashlyticsPlugin", "addLog", [defaults]);
};

CrashlyticsPlugin.prototype.sendCrash = function(message) {
  var defaults = { message: message };

  cordova.exec(null, null, "CrashlyticsPlugin", "sendCrash", [defaults]);
};

CrashlyticsPlugin.prototype.sendNonFatalCrash = function(message) {
  var defaults = { message: message };

  cordova.exec(null, null, "CrashlyticsPlugin", "sendNonFatalCrash", [
    defaults,
  ]);
};
...
CrashlyticsPlugin.prototype.setUserIdentifier = function(userIdentifier) {
  ...
  cordova.exec(null, null, "CrashlyticsPlugin", "setUserIdentifier", [
    defaults,
  ]);
};
...
CrashlyticsPlugin.prototype.setUserName = function(userName) {
  ...
  cordova.exec(null, null, "CrashlyticsPlugin", "setUserName", [defaults]);
};
...
CrashlyticsPlugin.prototype.setUserEmail = function(userEmail) {
  ...
  cordova.exec(null, null, "CrashlyticsPlugin", "setUserEmail", [defaults]);
};
...
CrashlyticsPlugin.prototype.setStringValueForKey = function(value, key) {
  ...
  cordova.exec(null, null, "CrashlyticsPlugin", "setStringValueForKey", [
    defaults,
  ]);
};
...
CrashlyticsPlugin.prototype.setIntValueForKey = function(value, key) {
  ...
  cordova.exec(null, null, "CrashlyticsPlugin", "setIntValueForKey", [
    defaults,
  ]);
};
...
CrashlyticsPlugin.prototype.setBoolValueForKey = function(value, key) {
  ...
  cordova.exec(null, null, "CrashlyticsPlugin", "setBoolValueForKey", [
    defaults,
  ]);
};
...
CrashlyticsPlugin.prototype.setFloatValueForKey = function(value, key) {
  ...
  cordova.exec(null, null, "CrashlyticsPlugin", "setFloatValueForKey", [
    defaults,
  ]);
};
...
if (!window.plugins.crashlyticsPlugin) {
  window.plugins.crashlyticsPlugin = crashlyticsPanel;
}
